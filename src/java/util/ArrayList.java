        ...
        implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
     ...
     * 默认容量 也就是通过new ArrayList()创建时的默认容量。
     */
     ...
     * 这种是通过new ArrayList()创建时用的是这个空数组，与EMPTY_ELEMENTDATA的区别是在添加第
     * 一个元素时使用这个空数组的会初始化为DEFAULT_CAPACITY（10）个元素。
     */
    ...
    public void add(int index, E element) {
        ...
        //对内存直接进行复制，减少了for循环过程中的寻址时间，从而提高了效能 不安全的 浅拷贝
